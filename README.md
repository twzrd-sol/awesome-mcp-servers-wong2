...
- **[TWZRD Agent Intel](https://intel.twzrd.xyz)** - Trust scoring and x402 micropayment verification MCP server for AI agents on Solana. Free tools: `score_agent`, `preflight_check`. Paid: signed trust receipts via HTTP 402 + USDC (<$0.01). Zero-install: `https://intel.twzrd.xyz/mcp` (Streamable HTTP).
